node('master') {
    ...
    stage("Run Automation Suite") {
            ...
            sh "ssh ubuntu@34.194.17.165 -i \$mySecretKey -o 'StrictHostKeyChecking=no' 'ls; pwd; pwd; cd /home/ubuntu/git; pwd; git pull; ls; mvn test; 'StrictHostKeyChecking=no'; git push; '"
            //sh "pwd"
            //sh "pwd"
            //sh "ls"
            // sh "ls"
